...
## Архитектура (актуальная после сессии 4)
...
- [x] Разные иллюстрации (5 уникальных типов кадров)
- [x] Красивый PDF (профессиональная книжная вёрстка)
...
- [ ] Генерация через InstantID / IP-Adapter для реального сходства с фото
