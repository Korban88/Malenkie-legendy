...
def _prompt(payload: dict) -> str:
    ...
    return (
        ...
        '• Согласование прилагательных с родом: "Звёздное Сияние" (ср.р.), "Золотой Ветер" (м.р.) — НЕ "Звездный Сияние"\n'
        '• Конструкция "один из": время суток — "Одним ясным утром", "В ясное утро" — НЕ "В один из ясных утра"\n'
