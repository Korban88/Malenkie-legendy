...
def _prompt(payload: dict) -> str:
    ...
    return (
        ...
        'ГРАММАТИКА — КРИТИЧНО. ПРОВЕРЯЙ КАЖДОЕ ПРЕДЛОЖЕНИЕ ПЕРЕД ЗАПИСЬЮ.\n\n'
        ...
        'СТРОГО ЗАПРЕЩЁННЫЕ КОНСТРУКЦИИ (если встречаешь — переписывай):\n'
        '• «остановилася», «улыбнулася», «вернулася» — НЕТ ТАКИХ СЛОВ. Только «остановилась», «улыбнулась», «вернулась».\n'
